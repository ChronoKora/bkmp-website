-- Bkmp - Idle Drachen Dorf: dreizehnter Dorf-Skin "Nexo Dorf" (Video-Skin,
-- gleiches Schema wie Eisdorf/Enderdorf/Kartendorf), kaufbar fuer
-- 500.000 Gold.
...
-- (2216 x 936, echte Video-Massse, per MP4-Header ausgelesen) - siehe
-- Kommentar in supabase-idle-village-skins-pinguindorf.sql fuer die volle
-- Begruendung.
--
...
values ('nexodorf', 'Nexo Dorf', 'Ein Dorf ganz im Zeichen von Nexo.', '🔷', '', 'assets/village/nexodorf.mp4', 'purchase', 500000, 0, 1, 2216, 936, 13)
