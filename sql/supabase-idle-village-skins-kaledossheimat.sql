-- Bkmp - Idle Drachen Dorf: neuer Dorf-Skin "Kaledoss Heimat" (Video-Skin,
-- gleiches Schema wie Pinguindorf/Midas Stadt/Cyber Stadt), kaufbar fuer
-- 44.000.000 Gold.
...
values ('kaledossheimat', 'Kaledoss Heimat', 'Ein Dorf ganz im Zeichen von Kaledoss.', '🏡', '', 'assets/village/kaledossheimat.mp4', 'purchase', 44000000, 0, 1, 1764, 1176, 15)
