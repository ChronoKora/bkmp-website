-- Bkmp - Idle Drachen Dorf: zehnter Dorf-Skin "Eis Dorf" (Video-Skin,
...
-- (2458 x 844, echte Video-Massse) - siehe Kommentar in
...
values ('eisdorf', 'Eis Dorf', 'Ein vereistes Dorf inmitten glitzernder Schnee- und Eislandschaften.', '❄️', '', 'assets/village/eisdorf.mp4', 'purchase', 150000, 0, 1, 2458, 844, 10)
