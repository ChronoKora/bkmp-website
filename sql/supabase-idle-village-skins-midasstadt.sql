-- Bkmp - Idle Drachen Dorf: siebter Dorf-Skin "Midas Stadt" (Video-Skin,
...
-- (2076 x 998, echte Video-Massse) - siehe Kommentar in
...
values ('midasstadt', 'Midas Stadt', 'Eine glaenzende, komplett vergoldete Stadt.', '👑', '', 'assets/village/midasstadt.mp4', 'purchase', 500000000, 0, 1, 2076, 998, 7)
